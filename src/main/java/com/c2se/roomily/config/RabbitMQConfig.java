...
public class RabbitMQConfig {
    ...
    public static final String ADS_CLICK_QUEUE = "ad-click-queue";
    public static final String ROOM_ROUTING_KEY = "room-key";
    public static final String EVENT_ROUTING_KEY = "event-key";
    public static final String ADS_CLICK_ROUTING_KEY = "ad-click-key";
    public static final String ADS_CONVERSION_QUEUE = "ad-conversion-queue";
    public static final String ADS_CONVERSION_ROUTING_KEY = "ad-conversion-key";
    ...
    @Bean
    SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory(ConnectionFactory rabbitMQconnectionFactory) {
    ...
    @Bean
    Queue adClickQueue() {
        return new Queue(ADS_CLICK_QUEUE, false);
    }

    @Bean
    Queue adConversionQueue() {
        return new Queue(ADS_CONVERSION_QUEUE, false);
    }
    ...
    Binding adClickBinding(Queue adClickQueue, TopicExchange adsExchange) {
        return BindingBuilder.bind(adClickQueue).to(adsExchange).with(ADS_CLICK_ROUTING_KEY);
    }

    @Bean
    Binding adConversionBinding(Queue adConversionQueue, TopicExchange adsExchange) {
        return BindingBuilder.bind(adConversionQueue).to(adsExchange).with(ADS_CONVERSION_ROUTING_KEY);
    }
